/******************************************************************************
                  ...
                  °æÈ¨ËùÓÐ (C), 2001-2011, º£¿Õ

 ******************************************************************************
  ÎÄ ¼þ Ãû   : ascii.c
  °æ ±¾ ºÅ   : ³õ¸å
  ×÷    Õß   : haikong
  Éú³ÉÈÕÆÚ   : 2014Äê11ÔÂ3ÈÕ
  ×î½üÐÞ¸Ä   :
  ¹¦ÄÜÃèÊö   : ASCIIÂë±àÂëÎ»Í¼»ñÈ¡
  º¯ÊýÁÐ±í   :
              ASCIIFontInit
              ASCIIGetFontBitmap
              ASCIIInit
  ÐÞ¸ÄÀúÊ·   :
  1.ÈÕ    ÆÚ   : 2014Äê11ÔÂ3ÈÕ
    ×÷    Õß   : haikong
    ÐÞ¸ÄÄÚÈÝ   : ´´½¨ÎÄ¼þ
...
/*****************************************************************************
 º¯ Êý Ãû  : ASCIIFontInit
 ¹¦ÄÜÃèÊö  : ASCII×ÖÌåÄ£¿éµÄ³õÊ¼»¯º¯Êý
 ÊäÈë²ÎÊý  : char *pcFontFile           - Î´Ê¹ÓÃ
             unsigned int dwFontSize    - ×Ö·û³ß´ç,±ØÐëÊÇ16,·ñÔòÊ§°Ü(ÒòÎªÎÒÃÇÖ»ÓÐ8x16Î»Í¼)
 Êä³ö²ÎÊý  : ÎÞ
 ·µ »Ø Öµ  : 0 - ³É¹¦, ÆäËûÖµ - Ê§°Ü
 µ÷ÓÃº¯Êý  :
 ±»µ÷º¯Êý  :
...
/*****************************************************************************
 º¯ Êý Ãû  : ASCIIGetFontBitmap
 ¹¦ÄÜÃèÊö  : »ñµÃASCII×Ö·ûµÄÎ»Í¼
 ÊäÈë²ÎÊý  : unsigned int dwCode            - ×Ö·ûµÄASCII±àÂëÖµ
             PT_FontBitMap ptFontBitMap     - ÄÚº¬Î»Í¼ÐÅÏ¢
 Êä³ö²ÎÊý  : ÎÞ
 ·µ »Ø Öµ  : 0 - ³É¹¦, -1 - Ê§°Ü
 µ÷ÓÃº¯Êý  :
 ±»µ÷º¯Êý  :
...
int ASCIIInit(void)
{
    DBG_PRINTF("g_tASCIIFontOpr.name = %s\n",g_tASCIIFontOpr.name);
