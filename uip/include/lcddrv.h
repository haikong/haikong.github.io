...
#define FORMAT24BPP_LSB 0
#define FORMAT24BPP_MSB 1
...
#define VFPD_240320		((2-1)&0xff)
#define VSPW_240320		((10-1) &0x3f)
#define HBPD_240320		((2-1)&0x7f)
#define HFPD_240320		((2-1)&0xff)
#define HSPW_240320		((41-1)&0xff)

//TFT LCD Panel(480*272)
#define MODE_TFT_1BIT_480272     (0x4801)
#define MODE_TFT_8BIT_480272	 (0x4802)
#define MODE_TFT_16BIT_480272    (0x4804)
#define MODE_TFT_24BIT_480272    (0x4808)

//TFT 272480
#define LCD_XSIZE_TFT_272480 	(480)
#define LCD_YSIZE_TFT_272480 	(272)

//TFT 272480
#define HOZVAL_TFT_272480	(LCD_XSIZE_TFT_272480-1)
#define LINEVAL_TFT_272480	(LCD_YSIZE_TFT_272480-1)

#define CLKVAL_TFT_272480	(4)
// 60hz @100Mhz

//Timing parameter for TQ043TSCM
#define VBPD_272480		((2-1)&0xff)
#define VFPD_272480		((2-1)&0xff)
#define VSPW_272480		((10-1) &0x3f)
#define HBPD_272480		((2-1)&0x7f)
#define HFPD_272480		((2-1)&0xff)
#define HSPW_272480		((41-1)&0xff)
...
#define VBPD_640480		((2-1)&0xff)
#define VFPD_640480		((2-1)&0xff)
#define VSPW_640480		((10-1) &0x3f)
#define HBPD_640480		((2-1)&0x7f)
#define HFPD_640480		((2-1)&0xff)
#define HSPW_640480		((41-1)&0xff)
...
/*
*获取LCD fb start address
*/
unsigned int GetLcdFBbase(void);

/*
*获取LCD bpp
*/
unsigned int GetLcdBpp(void);

/*
*获取LCD x-size
*/
unsigned int GetLcdXsize(void);

/*
*获取LCD y-size
*/
unsigned int GetLcdYsize(void);
